    ...
    public function toArray($request)
    {
        return [
            ...
            "attributes" => [
                ...
                "usuario_comisionado" => $this->resource->getUsuarioComisionado != null ? $this->resource->getUsuarioComisionado : null,
                "dependencia_duena" => $this->resource->getDependenciaDuena,
                "dependencia_actual" => $this->resource->getDependenciaActual,
