    ...
    public function toArray($request)
    {
        return [
            ...
            "attributes" => [
                ...
                "fecha_actualizacion" => date("d/m/Y h:i:s A", strtotime($this->resource->fecha_actualizacion)),
                ...
                "etapa" => $this->resource->getEtapa,
                "ultimo_transpaso" => $this->resource->getUltimaTranspasoAccion($this->resource->getRouteKey()),
                "migrado" => $this->resource->migrado,
                "usuario_actual" => $this->resource->getUsuarioActual($this->resource->getRouteKey()),
                "ultima_descripcion_log" => $this->resource->ultima_descripcion_log
