...
trait RepartoAleatorioTrait
{
    ...
    public static function storeRepartoAleatorioPorGrupo($user_name, $id_dependencia, $id_grupoTrabajo, $id_tipo_queja)
    {
        // Consulta que realiza el reparto aleatorio asignando los casos al que menos cantidad de procesos este gestionando.
        $results = DB::select(
            "
            ...
            AND te.tipo_expediente_id = " . Constants::TIPO_EXPEDIENTE['proceso_disciplinario'] . "
            AND te.sub_tipo_expediente_id = " . $id_tipo_queja . "
            ORDER BY u.numero_casos ASC"
        );
