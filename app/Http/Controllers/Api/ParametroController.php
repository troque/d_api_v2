...
class ParametroController extends Controller
{
    ...
    {
        $datosRequest = $request->validated()["data"]["attributes"];
        $nombre_campo = $datosRequest["nombre"];
        ...
        $consulta = DB::select("
                select
                    ...
                    type,
                    value
                from mas_parametro_campos
                where Translate(upper(nombre_campo),'ÁáÉéÍíÓóÚú','AaEeIiOoUu') = Translate(upper('" . $nombre_campo . "'),'ÁáÉéÍíÓóÚú','AaEeIiOoUu')
            ");
