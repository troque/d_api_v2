...
class TipoSujetoProcesalController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = $query->select('mas_tipo_sujeto_procesal.id', 'mas_tipo_sujeto_procesal.nombre', 'mas_tipo_sujeto_procesal.estado')->orderBy('mas_tipo_sujeto_procesal.nombre', 'asc')->get();
    ...
    /**
     * Retorna la lista de sujetos procesales activos.
     *
     * @return \Illuminate\Http\Re
     */
    public function showActivos(Request $request)
    {
        $query = TipoSujetoProcesalModel::query();
        $query = $query->select('mas_tipo_sujeto_procesal.id', 'mas_tipo_sujeto_procesal.nombre', 'mas_tipo_sujeto_procesal.estado')->where('estado', Constants::ESTADOS['activo'])->orderBy('mas_tipo_sujeto_procesal.nombre', 'asc')->get();
