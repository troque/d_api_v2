...
Route::middleware(['cors'])->group(function ($route) {
    ...
    Route::middleware('auth:sanctum')->get('tipo-sujeto-procesal-activo',  [TipoSujetoProcesalController::class, 'showActivos']);
    ...
    Route::middleware('auth:sanctum')->get('proceso-diciplinario/actualizar-vigencia/{id_proceso_disciplinario}/{nueva_vigencia}',  [ProcesoDiciplinarioController::class, 'actualizarVigencia']);
    ...
    Route::middleware('auth:sanctum')->get('mis-transacciones',  [MisPendientesController::class, 'getMisTransacciones']);
    ...
    Route::middleware('auth:sanctum')->post('datos-interesado/getDatosInteresados/{numeroProcesoSinproc}/{vigencia}',  [DatosInteresadoController::class, 'getDatosInteresadoByRadicado']);
    ...
    Route::middleware('auth:sanctum')->post('log-proceso-disciplinario/get-log-etapa-actuaciones/{id_proceso_disciplinario}',  [LogProcesoDisciplinarioController::class, 'getLogEtapaByIdProcesoDisciplinarioActuaciones']);
    ...
    Route::middleware('auth:sanctum')->post('log-proceso-disciplinario/get-casos-por-usuario/{estado}',  [LogProcesoDisciplinarioController::class, 'getReporteCasosAsignadosPorUsuario']);
    ...
    Route::middleware('auth:sanctum')->post('log-proceso-disciplinario/get-casos-por-dependencia/{estado}',  [LogProcesoDisciplinarioController::class, 'getReporteCasosAsignadosPorDependencia']);
    ...
    Route::middleware('auth:sanctum')->post('actuaciones/set-guardar-auto/{id}',  [ActuacionesController::class, 'setNumeroAuto']);
    ...
    Route::middleware('auth:sanctum')->get('actuaciones/set-fecha-registro/{id_actuacion}/{fecha}',  [ActuacionesController::class, 'actualizarFechaRegistro']);
    ...
    Route::middleware('auth:sanctum')->get('actuaciones/get-actuaciones-proceso-disciplinario-auto/{id_proceso_disciplinario}',  [ActuacionesController::class, 'obtenerActuacionesPorProcesoDiscipinarioYAuto']);
    ...
    Route::middleware('auth:sanctum')->get('portal-log/buscar-usuario-log/{cedula}',  [PortalLogController::class, 'buscarUsuario']);
    ...
    Route::middleware('auth:sanctum')->get('portal-notificaciones-proceso/{radicado}/{vigencia}',  [PortalNotificacionesController::class, 'notificacionesRadicadoVigencia']);
    ...
    Route::middleware('auth:sanctum')->post('actualizar-estado-portal-notificaciones',  [PortalNotificacionesController::class, 'updateEstadoNotificacion']);
    ...
    Route::middleware('auth:sanctum')->post('activar-proceso',  [CambioEtapaController::class, 'activarProcesoDisciplinario']);
    ...
    Route::middleware('auth:sanctum')->post("portal-web/obtener-documento-actuaciones", [PortalController::class, 'obtenerDocumentoActuaciones']);
});
