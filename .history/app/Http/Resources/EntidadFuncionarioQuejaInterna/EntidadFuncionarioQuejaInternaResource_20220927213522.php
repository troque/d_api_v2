...
class EntidadFuncionarioQuejaInternaResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            "attributes" => [
                "se_identifica_investigado" => $this->resource->se_identifica_investigado?"Si":"No",
                ...
                "numero_contrato" => $this->resource->id_tipo_funcionario==2?$this->resource->numero_contrato:"",
