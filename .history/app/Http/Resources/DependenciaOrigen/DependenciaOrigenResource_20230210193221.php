    ...
    public function toArray($request)
    {
        return [
            ...
            "attributes" => [
                ...
                "nombre_solo_usuario_jefe" => mb_strtoupper($this->resource->usuario_jefe == null ? "" : $this->resource->usuario_jefe->name),
                "nombre_usuario_jefe" => mb_strtoupper($this->resource->usuario_jefe == null ? "" : $this->resource->usuario_jefe->name . ' (' . $this->resource->usuario_jefe->nombre . ' ' . $this->resource->usuario_jefe->apellido . ')'),
