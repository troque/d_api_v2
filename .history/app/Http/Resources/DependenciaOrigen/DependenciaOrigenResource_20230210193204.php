    ...
    public function toArray($request)
    {
        return [
            ...
            "attributes" => [
                ...
                "nombre_usuario_jefe" => $this->resource->usuario_jefe == null ? "" : $this->resource->usuario_jefe->name . ' (' . $this->resource->usuario_jefe->nombre . ' ' . $this->resource->usuario_jefe->apellido . ')',
