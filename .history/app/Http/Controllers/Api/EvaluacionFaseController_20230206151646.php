...
class EvaluacionFaseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = $query->select('evaluacion_fase.id', 'evaluacion_fase.id_fase_actual', 'evaluacion_fase.id_fase_antecesora', 'evaluacion_fase.id_resultado_evaluacion')->get();
    ...
    public function showListaConfiguracion()
    {
        $query = $this->repository->customQuery(function ($model) {
            return $model->select('evaluacion_fase.*')->get();
        });
