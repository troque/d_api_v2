    ...
    public function buscadorGeneral(BuscadorFormRequest $request)
    {
        ...
        OUTER  APPLY
            ( SELECT inte.uuid, inte.id_etapa, inte.id_tipo_interesao, inte.id_tipo_sujeto_procesal, inte.id_proceso_disciplinario,
                ...
                inte.id_departamento, inte.id_ciudad, inte.direccion, inte.localidad, inte.email, inte.telefono_celular, inte.telefono_fijo,
                inte.id_sexo, inte.id_genero, inte.id_orientacion_sexual, inte.entidad, inte.cargo, inte.tarjeta_profesional, inte.id_dependecia,
