...
class HomeController extends Controller
{
    ...
    public function getProcesosPorEtapa()
    {
        ...
        for ($cont = 0; $cont < count($procesos_etapa); $cont++) {
            ...
            $reciboDatos['attributes']['id_etapa'] = $procesos_etapa[$cont]->id_etapa;
            $reciboDatos['attributes']['nombre_etapa'] = $procesos_etapa[$cont]->nombre;
            $reciboDatos['attributes']['cant_etapa'] = $procesos_etapa[$cont]->cant_etapa;
