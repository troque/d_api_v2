                            ...
                            if (count($persona) > 0) {
                                ...
                                if ($quejoso[0]->id_empresa != 0) {
                                    ...
                                    if (count($empresa) > 0) {
                                        ...
                                        error_log("id_dependencia_personeria" . $empresa[0]->id_dependencia_personeria);

                                        if($empresa[0]->id_dependencia_personeria==null){
                                            datosInteresado['id_dependencia_entidad'] = 9999;
                                        }

                                        $datosInteresado['id_dependencia_entidad'] = $empresa[0]->id_dependencia_personeria != null ? $datosInteresado['id_dependencia_entidad'] ;
                                    }
                                }
