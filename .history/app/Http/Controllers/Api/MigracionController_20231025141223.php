...
class MigracionController extends Controller
{
    ...
    public function iniciarMigracionFromDisciplinarios()
    {
        ...
        $cant_total = DB::select("SELECT count(*) as total FROM DISC_SOLICITUDES WHERE num_solicitud  IN (328835)");
        $total = $cant_total[0]->total;
        ...
        for ($cont = 0; $cont < $total; $cont++) {
            ...
            if (count($etapa) > 0 && count($existe_proceso) == 0) {
                ...
                if (count($cerrar_etapa_evaluacion) > 0) {
                    ...
                    error_log("ID_PROCESO_DISCIPLINARIO: " . $array_proceso->id);
            ...
            /*} catch (Exception $e) {
                ...
                error_log(" " . $query_disc_solicitudes[$cont]->num_solicitud . "-" . $query_disc_solicitudes[$cont]->vigencia);
                error_log(" " . $query_disc_solicitudes[$cont]->num_solicitud . "-" . $query_disc_solicitudes[$cont]->vigencia);
