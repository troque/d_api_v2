...
class AutoFinalizaController extends Controller
{
    ...
    {
         try{
            return AutoFinalizaFormRequest::make($this->repository->create($request->validated()));
        } catch (\Exception $e) {
    ...
    {
        return AutoFinalizaResource::make($this->repository->update($request->validated(),$id));
    }
