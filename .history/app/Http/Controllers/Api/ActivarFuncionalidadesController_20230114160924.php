...
class ActivarFuncionalidadesController extends Controller
{
     ...
     * @return json
     */
    public function validarTipoProcesoPoderPreferente($id_proceso_disciplinario)
    {
        ...
        if (!empty($proceso_disciplinario) && $tipo_expediente[0]->id_tipo_expediente ==  Constants::TIPO_EXPEDIENTE['queja'] &&  $tipo_expediente[0]->id_tipo_queja == Constants::TIPO_QUEJA['interna']) {
            $reciboDatos['queja_interna'] = true;
        } else {
            $reciboDatos['queja_interna'] = false;
        }
