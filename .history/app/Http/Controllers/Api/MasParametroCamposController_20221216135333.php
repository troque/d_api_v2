...
class MasParametroCamposController extends Controller
{
    ...
    {
        return ParametroCamposResource::make($this->repository->create($request->validated()["data"]["attributes"]));
    }
    ...
    {
        return ParametroCamposResource::make($this->repository->update($request->validated()["data"]["attributes"], $id));
    }
