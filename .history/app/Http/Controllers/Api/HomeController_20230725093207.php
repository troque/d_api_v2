...
class HomeController extends Controller
{
    ...
    public function getProcesosPorEtapa()
    {
        ...
        for ($cont = 0; $cont < count($procesos_etapa); $cont++) {
            ...
            $json['data']['attributes']['id_etapa'] = $procesos_etapa[$cont]->id_etapa;
            $json['data']['attributes']['etapa'] = $procesos_etapa[$cont]->nombre;
            $json['data']['attributes']['cant_etapa'] = $procesos_etapa[$cont]->cant_etapa;
        }
    }
}
