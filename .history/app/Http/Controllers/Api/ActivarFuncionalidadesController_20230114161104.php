...
class ActivarFuncionalidadesController extends Controller
{
     ...
     * @return json
     */
    public function validarTipoProcesoPoder($id_proceso_disciplinario)
    {
        ...
        if (!empty($proceso_disciplinario) && $proceso_disciplinario[0]->id_tipo_proceso == Constants::TIPO_DE_PROCESO['poder_preferente']) {
