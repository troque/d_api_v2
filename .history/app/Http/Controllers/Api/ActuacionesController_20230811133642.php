...
class ActuacionesController extends Controller
{
    ...
    public function store(ActuacionesFormRequest $request)
    {
        try {
            ...
            error_log("VALOR DE TIPO DE ACTUACION ".$masActuacionesData[0]["tipo_actuacion"])
        ...
        try {
            ...
            $expediente = DB::select(
                "
                    ...
                    LEFT JOIN mas_estado_actuaciones mea ON a.id_estado_actuacion = mea.id
            ...
            if (count($expediente) > 0) {
                ...
                if ($expediente[0]->codigo == Constants::ESTADO_ACTUACION['rechazada']) {
