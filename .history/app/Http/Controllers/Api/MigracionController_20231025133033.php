...
class MigracionController extends Controller
{
    ...
    public function iniciarMigracionFromDisciplinarios()
    {
        ...
        try {
            ...
            //$query_disc_solicitudes = DB::select("SELECT num_solicitud, vigencia, tabla FROM DISC_SOLICITUDES WHERE num_solicitud  IN (328835)");
            ...
            for ($cont = 0; $cont < $total; $cont++) {
                ...
                if (count($etapa) > 0 && count($existe_proceso) == 0) {
                    ...
                    if ($query_disc_solicitudes[$cont]->tabla == 'DISC_INGRESO_DESGLOSE') {
                        ...
                        $datosProcesoDisciplinario['numero_auto'] =  $proceso[0]->auto_numero;
                        $datosProcesoDisciplinario['radicado_padre'] =  $proceso[0]->num_solicitud_padre;
                        //$datosProcesoDisciplinario['vigencia_padre'] =  $proceso[0]->num_solicitud_padre;
                        $datosProcesoDisciplinario['fecha_auto_desglose'] =  $proceso[0]->fecha_auto;
                    }
                    ...
                    if (count($remision_queja) > 0 && ($datosClasificacion['id_tipo_expediente'] != Constants::TIPO_EXPEDIENTE['derecho_peticion'] || $datosClasificacion['id_tipo_expediente'] != Constants::TIPO_EXPEDIENTE['tutela'])) {
                        ...
                        //error_log($array_remision_queja);
            ...
            DB::delete(DB::raw("delete from antecedente where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from interesado where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from clasificacion_radicado where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from entidad_investigado where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from documento_sirius where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from validar_clasificacion where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from evaluacion where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from remision_queja where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from gestor_respuesta where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from comunicacion_interesado where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from documento_cierre where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from informe_cierre where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from requerimiento_juzgado where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from actuaciones where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from cierre_etapa where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from log_proceso_disciplinario where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from proceso_disciplinario_por_semaforo where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from proceso_disciplinario where id_proceso_disciplinario = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from proceso_poder_preferente where uuid = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from proceso_desglose where uuid = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from proceso_sinproc where uuid = :somevariable"), array('somevariable' => $array_proceso->id));
            DB::delete(DB::raw("delete from proceso_sirius where uuid = :somevariable"), array('somevariable' => $array_proceso->id));




delete log_proceso_disciplinario where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete proceso_disciplinario_por_semaforo where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete proceso_disciplinario where radicado = '119';
COMMIT;
delete proceso_poder_preferente where id_tramite_usuario = '119';
COMMIT;
