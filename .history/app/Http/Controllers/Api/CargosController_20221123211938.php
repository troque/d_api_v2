...
class CargosController extends Controller
{
    ...
    {
        return CargosResource::make($this->repository->create($request->validated()));
    }
    ...
    {
        return CargosResource::make($this->repository->update($request->validated(), $id));
    }
     ...
     */
    public function getCargosSinEstado()
    {
