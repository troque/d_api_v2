...
class InteresadoEntidadPermitidaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //return InteresadoEntidadPermitidaListResource::collection($this->repository->orderBy($request->get('nombre')));
        //return InteresadoEntidadPermitidaCollection::make($this->repository->paginate($request->limit ?? 10));
    }
    ...
    public function getNombreEntidad($idEntidad)
    {
        ...
        $query = $query->where("identidad", $idEntidad)->select('entidad.*')->orderBy('entidad.nombre', 'asc')->get();
