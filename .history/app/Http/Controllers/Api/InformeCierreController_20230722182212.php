    ...
    public function show($id_proceso_disciplinario)
    {
        try {
            ...
            if ((strpos($e->getMessage(), 'Network') !== false) || (strpos($e->getMessage(), 'Request Entity Too Large') !== false)) {
                ...
                $error['estado'] = false;
                $error['error'] = 'No es posible realizar esta operación, si el problema persiste, comuniquese con el administrador.';
    ...
    public function storeArchivar($id_proceso_disciplinario)
    {
        try {
            ...
            try {
                ...
                $error = new stdClass;
                $error->estado = false;
                $error->error = "No fue posible enviar el correo electrónico, si el problema persiste comuniquese con el administrador";
                return $error;
            }
