...
class HomeController extends Controller
{
    ...
    public function getProcesosPorEtapa()
    {
        ...
        for ($cont = 0; $cont < count($procesos_etapa); $cont++) {
            ...
            $json['data']['attributes'][$procesos_etapa[$cont]->id] = $procesos_etapa[$cont]->cant_etapa;
            $json['data']['attributes']['nombre_etapa_' . $procesos_etapa[$cont]->id] = $procesos_etapa[$cont]->cant_etapa;
