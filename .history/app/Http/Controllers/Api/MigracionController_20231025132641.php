...
delete antecedente where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119')
            ;
COMMIT;
delete interesado where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete clasificacion_radicado where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete entidad_investigado where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete documento_sirius where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete validar_clasificacion where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete evaluacion where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete remision_queja where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete gestor_respuesta where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete comunicacion_interesado where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete documento_cierre where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete informe_cierre where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete requerimiento_juzgado where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete actuaciones where uuid_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
delete cierre_etapa where id_proceso_disciplinario = (select uuid from proceso_disciplinario where radicado = '119');
COMMIT;
