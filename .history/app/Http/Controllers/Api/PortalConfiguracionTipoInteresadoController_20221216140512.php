...
class PortalConfiguracionTipoInteresadoController extends Controller
{
    ...
    {
        return PortalConfiguracionTipoInteresadoResource::make($this->repository->create($request->validated()["data"]["attributes"]));
    }
    ...
    {
        return PortalConfiguracionTipoInteresadoResource::make($this->repository->update($request->validated()["data"]["attributes"], $id));
    }
