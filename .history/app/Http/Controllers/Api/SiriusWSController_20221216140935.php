...
class SiriusWSController extends Controller
{
    ...
    {
        $this->sirius->login();
        return RadicacionResource::make($this->sirius->radicacion($request->validated()["data"]["attributes"]));
    }
    ...
    {
        $this->sirius->login();
        return SearchRadicadoResource::make($this->sirius->searchRadicado($request->validated()["data"]["attributes"]));
    }
}
