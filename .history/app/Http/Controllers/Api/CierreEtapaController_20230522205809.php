        ...
        try {
            ...
            if ($datosRequest['id_funcionario_asignado'] != null) {
                ...
                if (!empty($poder_preferente)) {
                    ProcesoDiciplinarioModel::where('uuid', $datosRequest['id_proceso_disciplinario'])->update(['id_etapa' => $poder_preferente[0]->id_etapa_asignada, 'id_dependencia_actual', $proceso_disciplinario[0]->id_dependencia_actual]);
                } else {
