...
class HomeController extends Controller
{
    ...
    public function getProcesosPorEtapa()
    {
        ...
        // CANTIDAD TOTAL DE PROCOESOS
        $procesos_etapa = DB::select("SELECT
        pd.id_etapa,
        me.nombre,
        ...
        WHERE lpd.id_funcionario_actual = '" . auth()->user()->name . "'
        GROUP BY pd.id_etapa, me.nombre");
        ...
        for ($cont = 0; $cont < count($procesos_etapa); $cont++) {
            ...
            $reciboDatos['data']['attributes']['id_etapa'] = $procesos_etapa[$cont]->id_etapa;
            $reciboDatos['data']['attributes']['etapa'] = $procesos_etapa[$cont]->nombre;
            $reciboDatos['data']['attributes']['cant_etapa'] = $procesos_etapa[$cont]->cant_etapa;
