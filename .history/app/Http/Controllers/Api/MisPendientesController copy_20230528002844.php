...
class MigracionController extends Controller
{
    ...
    public function iniciarMigracionFromDisciplinarios()
    {
        ...
        /*
        SOLO APLICA PARA PRUEBAS DEBE ELIMINARSE CUANDO SE PASE A PRODUCCION
        $query_disc_solicitudes = DB::select("SELECT num_solicitud, vigencia  FROM DISC_INGRESO_SINPROC");
        $cant_total = DB::select("SELECT count(*) as total FROM DISC_INGRESO_SINPROC");
        $total = $cant_total[0]->total;
        ...
        for ($cont = 0; $cont < $total; $cont++) {
            ...
            $num = $cont + 1;
            error_log($num . ' DE ' . $total . ' --> ' . $query_disc_solicitudes[$cont]->num_solicitud . ' - ' . $query_disc_solicitudes[$cont]->vigencia);
            ...
            if (count($etapa) > 0) {
                ...
                // SOLO APLICA PARA PRUEBAS DEBE ELIMINARSE CUANDO SE PASE A PRODUCCION
                if ($proceso[0]->id_dependencia == 310) { //SECRETARIA COMUN
                    $proceso[0]->id_dependencia = 413;
                } else if ($proceso[0]->id_dependencia == 64) { //PD PARA LA POTESTAD DISCIPLINARIA I FORSECURITY
                    $proceso[0]->id_dependencia = 414;
                } else if ($proceso[0]->id_dependencia == 31) { //PD PARA LA POTESTAD DISCIPLINARIA II FORSECURITY
                    $proceso[0]->id_dependencia = 415;
                } else if ($proceso[0]->id_dependencia == 5) { //PD PARA LA POTESTAD DISCIPLINARIA III FORSECURITY
                    $proceso[0]->id_dependencia = 416;
                } else if ($proceso[0]->id_dependencia == 61) { //PD PARA LA POTESTAD DISCIPLINARIA IV FORSECURITY
                    $proceso[0]->id_dependencia = 417;
                } else if ($proceso[0]->id_dependencia == 392) { //CONTROL INTERNO DISCIPLINARIO FORSECURITY
                    $proceso[0]->id_dependencia = 418;
                }

                // SOLO APLICA PARA PRUEBAS DEBE ELIMINARSE CUANDO SE PASE A PRODUCCION
                if ($etapa[0]->dependencia_finaliza == 310) { //SECRETARIA COMUN
                    $etapa[0]->dependencia_finaliza == 413;
                } else if ($etapa[0]->dependencia_finaliza == 64) { //PD PARA LA POTESTAD DISCIPLINARIA I FORSECURITY
                    $etapa[0]->dependencia_finaliza == 414;
                } else if ($etapa[0]->dependencia_finaliza == 31) { //PD PARA LA POTESTAD DISCIPLINARIA II FORSECURITY
                    $etapa[0]->dependencia_finaliza == 415;
                } else if ($etapa[0]->dependencia_finaliza == 5) { //PD PARA LA POTESTAD DISCIPLINARIA III FORSECURITY
                    $etapa[0]->dependencia_finaliza == 416;
                } else if ($etapa[0]->dependencia_finaliza == 61) { //PD PARA LA POTESTAD DISCIPLINARIA IV FORSECURITY
                    $etapa[0]->dependencia_finaliza == 417;
                } else if ($etapa[0]->dependencia_finaliza == 392) { //CONTROL INTERNO DISCIPLINARIO FORSECURITY
                    $etapa[0]->dependencia_finaliza == 418;
                }
                ...
                $datosProcesoDisciplinario['created_at'] = auth()->user()->name;
                ...
                $this->storeLogMigracion($etapa[0]->id_etapa, $array_proceso->id, $proceso[0]->id_dependencia, Constants::FASE['inicio_proceso_disciplinario'], $array_proceso->id, auth()->user()->name);
                ...
                if ($total_antecedentes > 0) {
                    ...
                    for ($cont_antecedente = 0; $cont_antecedente < $total_antecedentes; $cont_antecedente++) {
                        ...
                        $array_antecedentes = AntecedenteResource::make($model_antecedente->create($datosAntecedente));

                        //REGISTRAR EN EL LOG PROCESO DISCIPLINARIO
                        $this->storeLogMigracion($etapa[0]->id_etapa, $array_proceso->id, $antecedentes[$cont_antecedente]->id_dependencia, Constants::FASE['antecedentes'], $array_antecedentes->id, auth()->user()->name);
                    }
                }
                    ...
                    for ($cont_quejoso = 0; $cont_quejoso < $total_quejoso; $cont_quejoso++) {
                        ...
                        if (count($quejoso) > 0) {
                            ...
                            if (count($persona) > 0) {
                                ...
                                $datosInteresado['entidad'] = $quejoso[0]->id_empresa == 0 ? null : $quejoso[0]->id_empresa;
                                $datosInteresado['nombre_entidad'] = $quejoso[0]->id_empresa == 0 ? null : $quejoso[0]->id_empresa;
                                $datosInteresado['primer_apellido'] = $persona[0]->primer_apellido;
                                ...
                                $datosInteresado['id_dependencia_entidad'] = $proceso[0]->id_dependencia;
                                $datosInteresado['id_dependencia'] = $proceso[0]->id_dependencia;
                                $datosInteresado['autorizar_envio_correo'] = 1;
                                ...
                                //REGISTRAR EN EL LOG PROCESO DISCIPLINARIO
                                $this->storeLogMigracion(Constants::ETAPA['captura_reparto'], $array_proceso->id, $proceso[0]->id_dependencia, Constants::FASE['datos_interesado'], $array_interesado->id, auth()->user()->name);
                            }
                        }
                    }
                }
                ...
                if ($total_clasificacion > 0) {
                    ...
                    for ($cont_clasificacion = 0; $cont_clasificacion < $total_clasificacion; $cont_clasificacion++) {
                        ...
                        } else if ($clasificacion_radicado[$cont_clasificacion]->tipo_expediente == 103) { //  DERECHO DE PETICION GENERAL
                            $datosClasificacion['id_tipo_expediente'] = Constants::TIPO_EXPEDIENTE['derecho_peticion'];
                        ...
                        $datosClasificacion['id_dependencia'] = $clasificacion_radicado[$cont_clasificacion]->id_dependencia;
                        ...
                        //REGISTRAR EN EL LOG PROCESO DISCIPLINARIO
                        $this->storeLogMigracion($clasificacion_radicado[$cont_clasificacion]->id_etapa, $array_proceso->id, $proceso[0]->id_dependencia, Constants::FASE['clasificacion_radicado'], $array_clasificacion->id, auth()->user()->name);
                        ...
                        if ($datosClasificacion['id_etapa'] == 2) {
                            ...
                            //REGISTRAR EN EL LOG PROCESO DISCIPLINARIO
                            $this->storeLogMigracion(Constants::ETAPA['evaluacion'], $array_proceso->id, $proceso[0]->id_dependencia, Constants::FASE['validacion_clasificacion'], $array_validar_clasificacion->id, auth()->user()->name);
                        }
                    }
                }
                ...
                if ($total_entidad > 0) {
                    ...
                    for ($cont_entidad = 0; $cont_entidad < $total_entidad; $cont_entidad++) {
                        ...
                        //REGISTRAR EN EL LOG PROCESO DISCIPLINARIO
                        $this->storeLogMigracion($datosEntidad['id_etapa'], $array_proceso->id, $proceso[0]->id_dependencia, Constants::FASE['entidad_investigado'], $array_entidad->id, auth()->user()->name);
                    }
                }
                ...
                //REGISTRAR EN EL LOG PROCESO DISCIPLINARIO
                $this->storeLogMigracion($cerrar_etapa_captura_reparto[0]->id_etapa, $array_proceso->id, $proceso[0]->id_dependencia, Constants::FASE['cierre_captura_reparto'], $array_cierre_cr->id, auth()->user()->name);
                ...
                if (count($evaluacion) > 0) {
                    ...
                    //REGISTRAR EN EL LOG PROCESO DISCIPLINARIO
                    $this->storeLogMigracion(Constants::ETAPA['evaluacion'], $array_proceso->id, $proceso[0]->id_dependencia, Constants::FASE['evaluacion'], $array_evaluacion->id, auth()->user()->name);
                    ...
                    $requestRemisionQueja['id_dependencia_destino'] = $etapa[0]->dependencia_finaliza;
                    ...
                    $this->storeLogMigracion(Constants::ETAPA['evaluacion'], $array_proceso->id, $proceso[0]->id_dependencia, Constants::FASE['remision_queja'], $array_remision_queja->id, auth()->user()->name);
                }

                //REGISTRAR CERRAR ETAPA EVALUACION
                ...
                if (count($cerrar_etapa_evaluacion) > 0) {
                    $datosCierreEvaluacion['id_etapa'] =  Constants::ETAPA['evaluacion'];
                    $datosCierreEvaluacion['id_proceso_disciplinario'] = $array_proceso->id;
                    $datosCierreEvaluacion['created_user'] = auth()->user()->name;
                    $datosCierreEvaluacion['id_funcionario_asignado'] = auth()->user()->name;
                    $datosCierreEvaluacion['eliminado'] = false;
                    $datosCierreEvaluacion['created_at'] = $cerrar_etapa_evaluacion[0]->fecha_cierre;

                    $model_cierre_ev = new CierreEtapaModel();
                    $rta_cierre_ev = CierreEtapaResource::make($model_cierre_ev->create($datosCierreEvaluacion));
                    $array_cierre_ev = json_decode(json_encode($rta_cierre_ev));

                    //REGISTRAR EN EL LOG PROCESO DISCIPLINARIO
                    $this->storeLogMigracion(Constants::ETAPA['evaluacion'], $array_proceso->id, $proceso[0]->id_dependencia, Constants::FASE['cierre_evaluacion'], $array_cierre_ev->id, auth()->user()->name);
                }
            }
        }
