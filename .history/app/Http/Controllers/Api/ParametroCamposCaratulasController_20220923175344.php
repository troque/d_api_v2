...
class ParametroCamposCaratulasController extends Controller
{
    ...
    {
        return ParametroCamposCaratulaCollection::make($this->repository->paginate($request->limit ?? 10));
    }
    ...
    {
        return ParametroCamposCaratulaResource::make($this->repository->create($request->validated()));
    }
    ...
    {
        return ParametroCamposCaratulaResource::make($this->repository->update($request->validated(), $id));
    }
