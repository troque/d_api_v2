...
*/
    ...
    public function encabezadoDelProceso($id_proceso_disciplinario)
    {
        ...
        $proceso_disciplinario = DB::select("SELECT
                ...
                UPPER(CONCAT(CONCAT(u_registro.nombre, ' '), u_registro.apellido)) AS FUNCIONARIO_REGISTRO,
                pd.usuario_comisionado AS ID_USUARIO_COMISIONADO,
                UPPER(CONCAT(CONCAT(u_comisionado.nombre, ' '), u_comisionado.apellido)) AS USUARIO_COMISIONADO,
        ...
        $ultimo_antecedeente = DB::select("SELECT
