    ...
    public function store(DatosInteresadoFormRequest $request)
    {
        try {
            ...
            if ($datosRequest['numero_documento'] != '2030405060') {
                ...
                AND i.numero_documento = '" . $datosRequest['numero_documento'] . "' AND i.id_tipo_sujeto_procesal = " . $datosRequest['id_tipo_sujeto_procesal'] . " AND estado = " . Constants::ESTADOS['activo']);
    ...
    public function update(DatosInteresadoFormRequest $request, $id)
    {
        try {
            ...
            if ($estadoInicial ==  Constants::ESTADOS['inactivo'] && $datosRequestVal['numero_documento'] != '2030405060') {
                ...
                WHERE
                i.id_proceso_disciplinario = '" .  $datosRequest['id_proceso_disciplinario'] . "'
                AND i.numero_documento = '" . $datosRequestVal['numero_documento'] . "' AND i.id_tipo_sujeto_procesal = " . $datosRequestVal['id_tipo_sujeto_procesal'] . " AND estado = " . $estadoFinal);
