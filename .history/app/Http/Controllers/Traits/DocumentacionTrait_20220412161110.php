...
trait DocumentacionTrait
{
    ...
    public static function storeDocumento($datosRequest)
    {
        try {
            ...
            //$log_uuid = DB::select("select uuid from log_proceso_disciplinario where id_proceso_disciplinario = '".$datosRequest[0]['id_proceso_disciplinario']."' and id_estado = "+Constants::ESTADO_PROCESO_DISCIPLINARIO['remitido']);
            ...
            $log_uuid = DB::select("select uuid from log_proceso_disciplinario where id_proceso_disciplinario = '".$datosRequest[0]['id_proceso_disciplinario']."'
             and id_tipo_log = ".Constants::TIPO_LOG['etapa']." and id_estado = ".Constants::ESTADO_PROCESO_DISCIPLINARIO['remitido']);
