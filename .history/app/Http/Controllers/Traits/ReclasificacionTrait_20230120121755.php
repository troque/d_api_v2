...
trait ReclasificacionTrait
{
    ...
    public static function reclasificacionPorTipoExpediente($id_proceso_disciplinario)
    {
        ...
        DB::table('actuaciones_por_semaforo')->where('uuid_proceso_disciplinario', $id_proceso_disciplinario)->update(['eliminado' => true]);
        DB::table('archivo_actuaciones')->where('uuid_proceso_disciplinario', $id_proceso_disciplinario)->update(['eliminado' => true]);
