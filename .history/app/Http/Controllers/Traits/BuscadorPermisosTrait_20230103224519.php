...
trait PermisosExpedienteTrait
{
    ...
    public static function validarPermisosExpedienteById($user_id, $id_proceso_disciplinario)
    {
        ...
        where te.tipo_expediente_id = " . $tipo_expediente[0]->id_tipo_expediente . "
        and te.sub_tipo_expediente_id = " . $tipo_expediente[0]->sub_tipo_expediente_id . "
        and u.id = '" . $user_id . "' and u.reparto_habilitado = 1 and u.estado = 1");
