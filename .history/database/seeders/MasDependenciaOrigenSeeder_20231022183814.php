...
class MasDependenciaOrigenSeeder extends Seeder
{
    ...
    public function dependenciaOrigen()
    {
        return [
            ...
            [
                "id" => "311",
                "nombre" => "DIRECCION CENTRO DE CONCILIACIÓN",
                "estado" => 0,
                "codigo_homologado" => "311",
            ],
            [
                "id" => "312",
                "nombre" => "P.D. PARA CONSUMIDOR",
                "estado" => 0,
                "codigo_homologado" => "312",
            ],
            [
                "id" => "313",
                "nombre" => "P.D. PARA LA PROTECCIÓN DE LAS VÍCTIMAS",
                "estado" => 0,
            ...
            [
                "id" => "316",
                "nombre" => "P.D. PARA LA COOR.DEL MIN.PÚBLICO Y DERECHOS HUMANOS",
                "estado" => 0,
                "codigo_homologado" => "316",
            ],
            [
                "id" => "317",
                "nombre" => "P.D. PARA LA COORDINACIÓN DE VEEDURÍAS",
                "estado" => 0,
                "codigo_homologado" => "317",
            ],
            [
                "id" => "318",
                "nombre" => "P.D. PARA LA COORDINACIÓN DE ASUNTOS DISCIPLINARIOS",
                "estado" => 1,
