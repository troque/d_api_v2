...
class MasDependenciaConfiguracionSeeder extends Seeder
{
    ...
    public function dependenciaConfiguracion()
    {
        return [
            ...
            ["id_dependencia_origen" => "414", "id_dependencia_acceso" => "1"],
            ["id_dependencia_origen" => "414", "id_dependencia_acceso" => "2"],
            ["id_dependencia_origen" => "414", "id_dependencia_acceso" => "3"],
            ["id_dependencia_origen" => "414", "id_dependencia_acceso" => "4"],
            ["id_dependencia_origen" => "414", "id_dependencia_acceso" => "5"],
            ["id_dependencia_origen" => "414", "id_dependencia_acceso" => "6"],
            ["id_dependencia_origen" => "414", "id_dependencia_acceso" => "7"],
            ["id_dependencia_origen" => "414", "id_dependencia_acceso" => "10"],
            ["id_dependencia_origen" => "414", "id_dependencia_acceso" => "12", "porcentaje_asignacion" => "100"],
            ["id_dependencia_origen" => "414", "id_dependencia_acceso" => "13"],

            ["id_dependencia_origen" => "415", "id_dependencia_acceso" => "1"],
            ["id_dependencia_origen" => "415", "id_dependencia_acceso" => "2"],
            ["id_dependencia_origen" => "415", "id_dependencia_acceso" => "3"],
            ["id_dependencia_origen" => "415", "id_dependencia_acceso" => "4"],
            ["id_dependencia_origen" => "415", "id_dependencia_acceso" => "5"],
            ["id_dependencia_origen" => "415", "id_dependencia_acceso" => "6"],
            ["id_dependencia_origen" => "415", "id_dependencia_acceso" => "7", "porcentaje_asignacion" => "100"],
            ["id_dependencia_origen" => "415", "id_dependencia_acceso" => "10"],
            ["id_dependencia_origen" => "415", "id_dependencia_acceso" => "13"],

            ["id_dependencia_origen" => "416", "id_dependencia_acceso" => "1"],
            ["id_dependencia_origen" => "416", "id_dependencia_acceso" => "2"],
            ["id_dependencia_origen" => "416", "id_dependencia_acceso" => "3"],
            ["id_dependencia_origen" => "416", "id_dependencia_acceso" => "4"],
            ["id_dependencia_origen" => "416", "id_dependencia_acceso" => "5"],
            ["id_dependencia_origen" => "416", "id_dependencia_acceso" => "6"],
            ["id_dependencia_origen" => "416", "id_dependencia_acceso" => "7", "porcentaje_asignacion" => "100"],
            ["id_dependencia_origen" => "416", "id_dependencia_acceso" => "10"],
            ["id_dependencia_origen" => "416", "id_dependencia_acceso" => "13"],

            ["id_dependencia_origen" => "417", "id_dependencia_acceso" => "1"],
            ["id_dependencia_origen" => "417", "id_dependencia_acceso" => "2"],
            ["id_dependencia_origen" => "417", "id_dependencia_acceso" => "3"],
            ["id_dependencia_origen" => "417", "id_dependencia_acceso" => "4"],
            ["id_dependencia_origen" => "417", "id_dependencia_acceso" => "5"],
            ["id_dependencia_origen" => "417", "id_dependencia_acceso" => "6"],
            ["id_dependencia_origen" => "417", "id_dependencia_acceso" => "7", "porcentaje_asignacion" => "100"],
            ["id_dependencia_origen" => "417", "id_dependencia_acceso" => "10"],
            ["id_dependencia_origen" => "417", "id_dependencia_acceso" => "11"],

            ["id_dependencia_origen" => "418", "id_dependencia_acceso" => "1"],
            ["id_dependencia_origen" => "418", "id_dependencia_acceso" => "2"],
            ["id_dependencia_origen" => "418", "id_dependencia_acceso" => "3"],
            ["id_dependencia_origen" => "418", "id_dependencia_acceso" => "4"],
            ["id_dependencia_origen" => "418", "id_dependencia_acceso" => "5"],
            ["id_dependencia_origen" => "418", "id_dependencia_acceso" => "6"],
            ["id_dependencia_origen" => "418", "id_dependencia_acceso" => "7", "porcentaje_asignacion" => "100"],
            ["id_dependencia_origen" => "418", "id_dependencia_acceso" => "9"],
