...
class MasDependenciaConfiguracionSeeder extends Seeder
{
    ...
    public function dependenciaConfiguracion()
    {
        return [
            ...
            ["id_dependencia_origen" => "412", "id_dependencia_acceso" => "12"],
            ["id_dependencia_origen" => "412", "id_dependencia_acceso" => "5"],
            ["id_dependencia_origen" => "412", "id_dependencia_acceso" => "6"],

            ["id_dependencia_origen" => "413", "id_dependencia_acceso" => "7", "porcentaje_asignacion" => "100"],
            ["id_dependencia_origen" => "413", "id_dependencia_acceso" => "12", "porcentaje_asignacion" => "100"],
            ...
            ["id_dependencia_origen" => "415", "id_dependencia_acceso" => "12", "porcentaje_asignacion" => "100"],

            ["id_dependencia_origen" => "416", "id_dependencia_acceso" => "7", "porcentaje_asignacion" => "100"],
            ["id_dependencia_origen" => "416", "id_dependencia_acceso" => "12", "porcentaje_asignacion" => "100"],

            ["id_dependencia_origen" => "417", "id_dependencia_acceso" => "7", "porcentaje_asignacion" => "100"],

            ["id_dependencia_origen" => "418", "id_dependencia_acceso" => "12", "porcentaje_asignacion" => "100"],
