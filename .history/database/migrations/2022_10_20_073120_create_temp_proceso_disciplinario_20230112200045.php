...
class CreateTempProcesoDisciplinario extends Migration
{
    ...
    public function up()
    {
        Schema::create('temp_proceso_disciplinario', function (Blueprint $table) {
            ...
            $table->integer("id_sub_tipo_expediente")->nullable();
            $table->integer("id_tipo_evaluacion")->nullable();
            $table->integer("id_tipo_conducta")->nullable();
            $table->string("radicado_padre_desglose")->nullable();
            $table->string("vigencia_padre_desglose")->nullable();
