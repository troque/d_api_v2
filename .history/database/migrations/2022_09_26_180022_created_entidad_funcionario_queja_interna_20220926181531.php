...
class CreatedEntidadFuncionarioQuejaInterna extends Migration
{
    ...
    public function up()
    {
        Schema::create('entidad_funcionario_queja_interna', function (Blueprint $table) {
            ...
            $table->integer('primer_nombre')->nullable();
            $table->integer('segundo_nombre')->nullable();
            $table->integer('primer_apellido')->nullable();
            $table->integer('segundo_apellido')->nullable();
