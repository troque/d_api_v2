...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('trazabilidad_actuaciones_anuladas', function (Blueprint $table) {
            ...
            $table->foreignUuid('uuid_trazabilidad_actuaciones')->constrained('trazabilidad_actuaciones', 'uuid');
            $table->foreignUuid('uuid_actuacion')->constrained('actuaciones', 'uuid');
            $table->foreignId('id_dependencia')->constrained('mas_dependencia_origen', 'id');
