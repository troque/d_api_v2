...
use App\Http\Controllers\Api\ConsecutivoDesgloseController;
...
Route::middleware(['cors'])->group(function ($route) {
    ...
    Route::middleware('auth:sanctum')->get('actuaciones/get-documentos-pendientes-de-firma/{id}',  [ActuacionesController::class, 'FirmasPorUsuario']);
    DocumentosPendientesDeFirmaPorUsuario
    ...
    Route::middleware('auth:sanctum')->post('mas_actuaciones/parametros-plantilla/{idActuacion}',  [MasActuacionesController::class, 'getParametrosPlantilla']);
